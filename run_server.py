...
Detects ROBOFANG_PORT/MCP_PORT/PORT env to switch between HTTP (Tauri spawn)
and stdio (Claude Desktop). Overwrites sys.argv before argparse to prevent
PyInstaller frozen args from leaking.
"""
