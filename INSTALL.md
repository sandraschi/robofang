...
4. Start the server:
   ...
   uv run python -m robofang.server

   # HTTP mode (for web dashboard)
   uv run uvicorn robofang.server:app --port 10871
   ```
5. Open `http://localhost:10871` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/robofang/issues) |
