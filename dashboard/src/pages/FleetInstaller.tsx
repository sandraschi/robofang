...
import {
    Download, CheckCircle2, XCircle, Loader2, Package,
    ChevronRight, ShieldCheck
} from 'lucide-react';
import { getFleetMarket, installFleetNode, getFleetInstallerStatus } from '../api';
    ...
    return (
        <div className="space-y-10 max-w-7xl mx-auto pb-20">
                ...
                <div className="flex items-center justify-between">
                    ...
                    {selected.size > 0 && (
                        <motion.button
                            ...
                            className="btn-primary flex items-center gap-3 px-8 py-4 rounded-2xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold transition-all shadow-lg shadow-indigo-600/20"
                        >
                            <Download size={20} />
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between text-[10px] font-bold uppercase tracking-widest mt-auto">
                                    <span className="text-slate-600">Port {node.port}</span>
            ...
            {Object.values(statuses).some(s => s.status === 'installing') && (
                ...
                >
                    <div className="bg-[#0a0a16] border border-white/10 rounded-3xl p-6 shadow-2xl backdrop-blur-xl">
