...
class OrchestrationClient:
    ...
    def _init_connectors(self):
        ...
        1. OPENFANG_CONNECTORS env var (comma-separated, e.g. "moltbook,resonite")
        ...
        if enabled_str:
            ...
            self.logger.info(f"Connectors from OPENFANG_CONNECTORS env: {enabled_list}")
