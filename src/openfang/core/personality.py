"""
OpenFang Personality Engine: System prompt management and agent "vibes".
...
class PersonalityEngine:
    ...
    def __init__(
        ...
        self.logger = logging.getLogger("openfang.core.personality")
