...
class HousemakerHand(Hand):
    ...
    async def _on_pulse(self, orchestrator: Any):
        self.logger.info("Housemaker Hand: Commencing environmental architecture pulse.")
        ...
        self.logger.info("Analyzing WorldLabs Splat topology for furniture placement...")
        ...
        if hasattr(orchestrator, "memory"):
            ...
            orchestrator.memory.store("housemaker_spawn_count", count + 10)  # Bulk spawn
